        ...
        <>
            <div className="flex bg-white">
                ...
                <div className="flex w-full">
                    ...
                    <div className="flex w-full">
                        <Link href="/incharge/registeredEvents" className="w-full border-r-4 border-red-600 hover:p-2 flex justify-around text-sm sm:text-xl md:text-2xl lg:text-4xl xl:text-4xl p-1 lg:p-2 xl:p-2">
                            Registered Events
                        </Link>
                    </div>
                </div>
